...
-- CreateIndex
CREATE UNIQUE INDEX "Video_resumeId_key" ON "Video"("resumeId");

-- CreateIndex
CREATE INDEX "Video_resumeId_idx" ON "Video"("resumeId");
...
-- AddForeignKey
ALTER TABLE "Video" ADD CONSTRAINT "Video_resumeId_fkey" FOREIGN KEY ("resumeId") REFERENCES "Resume"("id") ON DELETE CASCADE ON UPDATE CASCADE;
